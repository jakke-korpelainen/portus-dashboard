...
pub const COMMON_NAMES: [&str; 32] = [
    "Virtanen", "Korhonen", "Mallinkainen", "Mäkinen", "Nieminen", "Mäkelä",
    "Hämäläinen", "Laine", "Häkkinen", "Koskinen", "Kovalainen", 
    "Järvinen", "Lehtonen", "Lehtinen", "Saarinen", "Salminen", 
    "Heinonen", "Niemi", "Heikkilä", "Kinnunen", "Salonen", 
    "Turunen", "Salo", "Laitinen", "Tuominen", "Rantanen", 
